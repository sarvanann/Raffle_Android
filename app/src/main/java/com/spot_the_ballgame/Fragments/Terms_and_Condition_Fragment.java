...
public class Terms_and_Condition_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.terms_and_condition_layout, container, false);
        Navigation_Drawer_Act.tv_title_txt.setText(R.string.t_and_c_txt);
        ...
        webView.loadUrl(Factory.BASE_HELP_TC_URL_MOBILE_APP + "terms_condtions");
        return view;
    }
...
//        Log.e("backStackCnt_terms", "" + backStackEntryCount);
