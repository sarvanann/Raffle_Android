...
public class Ranking_List_Adapter_My_History extends RecyclerView.Adapter<Ranking_List_Adapter_My_History.ViewHolder> {
    Context context;
    private ArrayList<Category_Model.Data> arrayList;

    public Ranking_List_Adapter_My_History(My_Contest_History game_two_act, ArrayList<Category_Model.Data> data) {
