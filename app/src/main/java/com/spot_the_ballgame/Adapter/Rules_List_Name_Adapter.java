...
public class Rules_List_Name_Adapter extends RecyclerView.Adapter<Rules_List_Name_Adapter.ViewHolder> {
    Context context;
    ...
    @NonNull
    @Override
    public Rules_List_Name_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view;
        view = inflater.inflate(R.layout.rules_name_list_adapter_details_layout, parent, false);
        return new Rules_List_Name_Adapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull Rules_List_Name_Adapter.ViewHolder holder, int position) {
