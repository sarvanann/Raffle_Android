...
public class Price_List_Adapter_My_History_For_Live extends RecyclerView.Adapter<Price_List_Adapter_My_History_For_Live.ViewHolder> {
    private ArrayList<Winnings_Model> arrayList;
    private Context context;
    private String str_prize_amount, str_rank;


    public Price_List_Adapter_My_History_For_Live(My_Contest_Live my_contest_history, ArrayList<Winnings_Model> winnings_model) {
