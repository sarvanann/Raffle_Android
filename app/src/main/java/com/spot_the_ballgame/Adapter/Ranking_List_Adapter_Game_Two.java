...
public class Ranking_List_Adapter_Game_Two extends RecyclerView.Adapter<Ranking_List_Adapter_Game_Two.ViewHolder> {
    Context context;
    private ArrayList<Category_Model.Data> arrayList;

    public Ranking_List_Adapter_Game_Two(Game_Two_Act game_two_act, ArrayList<Category_Model.Data> data) {
