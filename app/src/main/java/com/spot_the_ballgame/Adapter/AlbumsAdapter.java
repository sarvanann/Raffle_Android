...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.MyViewHolder> {
    ...
    private ArrayList<Carousel_Model.Banner_Contest> albumList;
    ...
    public AlbumsAdapter(FragmentActivity activity, ArrayList<Carousel_Model.Banner_Contest> normal_contest) {
        this.mContext = activity;
        this.albumList = normal_contest;
    }

    public AlbumsAdapter(ArrayList<Carousel_Model.Banner_Contest> banner_contest, FragmentActivity activity) {
        this.mContext = activity;
        this.albumList = banner_contest;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.album_card, parent, false);
...
//        Log.e("str_imagepathablbm", str_imagepath);
        Glide.with(mContext).load(str_imagepath)
                .thumbnail(Glide.with(mContext).load(str_imagepath))
//                .apply(RequestOptions.circleCropTransform())
                .into(holder.thumbnail);
//        holder.thumbnail.setLayoutParams(new ConstraintLayout.LayoutParams(1000, 500));

        /*holder.thumbnail.setScaleType(ImageView.ScaleType.CENTER_CROP);
        holder.thumbnail.setCornerRadius((float) 10);
        holder.thumbnail.setBorderWidth((float) 2);
        holder.thumbnail.setBorderColor(Color.DKGRAY);
        holder.thumbnail.mutateBackground(true);
        holder.thumbnail.setOval(true);
        holder.thumbnail.setTileModeX(Shader.TileMode.REPEAT);
        holder.thumbnail.setTileModeY(Shader.TileMode.REPEAT);*/

        String str_status = albumList.get(position).play_status;
        str_categories = albumList.get(position).categories;
        str_question_type = albumList.get(position).question_type;
...
//            Log.e("different_milli_seconds", String.valueOf(different_milli_seconds));
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String prize_type = albumList.get(position).prize_type;
//                Log.e("str_status_onclick", str_status_onclick);
//                Log.e("str_rule_id", str_rule_id);
//                Log.e("rules_name", albumList.get(position).rules_name);
//                Log.e("end_date_time", albumList.get(position).end_date_time);
