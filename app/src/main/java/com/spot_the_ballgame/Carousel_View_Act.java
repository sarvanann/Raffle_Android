...
public class Carousel_View_Act extends AppCompatActivity {
...
//        FullScreenMethod();
    ...
    private void FullScreenMethod() {
        ...
        if (currentApiVersion >= Build.VERSION_CODES.KITKAT) {
            Carousel_View_Act.this.getWindow().getDecorView().setSystemUiVisibility(flags);
            final View decorView = Carousel_View_Act.this.getWindow().getDecorView();
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btn_signup.setText(getString(R.string.sign_up_txt));
            } else {
