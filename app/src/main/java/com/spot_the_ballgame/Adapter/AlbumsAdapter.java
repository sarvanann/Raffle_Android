...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.MyViewHolder> {
    ...
    private ArrayList<Carousel_Model.Normal_Contest> albumList;
    ...
    public AlbumsAdapter(FragmentActivity activity, ArrayList<Carousel_Model.Normal_Contest> normal_contest) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        String str_team_a_path = albumList.get(position).image_url;
