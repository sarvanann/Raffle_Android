...
public class Rules_List_Name_Adapter_My_History_For_Live extends RecyclerView.Adapter<Rules_List_Name_Adapter_My_History_For_Live.ViewHolder> {
    Context context;
    private ArrayList<Category_Model.Data> arrayList;
    private ArrayList<String[]> comma_arrayList = new ArrayList<>();

    public Rules_List_Name_Adapter_My_History_For_Live(Context game_two_act, ArrayList<Category_Model.Data> data) {
    ...
    @NonNull
    @Override
    public Rules_List_Name_Adapter_My_History_For_Live.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view;
        view = inflater.inflate(R.layout.rules_name_list_adapter_details_layout, parent, false);
        return new Rules_List_Name_Adapter_My_History_For_Live.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull Rules_List_Name_Adapter_My_History_For_Live.ViewHolder holder, int position) {
